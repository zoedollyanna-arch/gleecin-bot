/**
 * Safe database migration script for PostgreSQL
 * Creates and updates schema for GLEECIN Academy without dropping data
...
const migrations = [
  ...
  `ALTER TABLE certifications ADD COLUMN IF NOT EXISTS completion_date TIMESTAMP`,
  `ALTER TABLE certificates ADD COLUMN IF NOT EXISTS shared BOOLEAN DEFAULT false`,
  `ALTER TABLE certificates ADD COLUMN IF NOT EXISTS shared_at TIMESTAMP`,
  `ALTER TABLE certificates ADD COLUMN IF NOT EXISTS pdf_url TEXT`,
  `ALTER TABLE certificates ADD COLUMN IF NOT EXISTS completion_date TIMESTAMP`,
